...
Den första skanningen visade en mycket hög risknivå. Den sårbara imagen var stor, cirka `1.46GB`, och rapporten innehöll `1299 HIGH` samt `181 CRITICAL` sårbarheter. Jag sparade både full rapport och en kort sammanfattning i rapportmappen för att kunna använda dem som bevis i inlämningen.
